...
import br.com.caelum.ingresso.services.DetalhesDoFilme;
...
public class FilmeController {
	...
	public ModelAndView detalhe(@PathVariable("filmeId") Integer id) {
		...
		List<Sessao> sessoes = sessaoDao.findAllByFilme(id);
